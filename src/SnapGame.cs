...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
			...
			SwinGame.LoadSoundEffect("slap1.wav");
			SwinGame.LoadSoundEffect("slap2.wav");
			SwinGame.LoadSoundEffect("slap3.wav");
		}
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			if (myGame.IsStarted) {
				if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT) && SwinGame.KeyTyped (KeyCode.vk_RSHIFT)) {
					SwinGame.PlaySoundEffect ("slap1.wav");
				} else if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT)) {
					SwinGame.PlaySoundEffect ("slap2.wav");
					myGame.PlayerHit (0);
				} else if (SwinGame.KeyTyped (KeyCode.vk_RSHIFT)) {
					SwinGame.PlaySoundEffect ("slap3.wav");
					myGame.PlayerHit (1);
				}
			}
		}
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 568, 205);
			}
			else
			{
			...
			SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), 52, 205, 205);
